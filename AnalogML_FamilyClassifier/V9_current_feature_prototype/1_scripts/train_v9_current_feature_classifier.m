...
% ============================================================
% V9 Hierarchical Classifier with Current/Impedance Features
% ============================================================
...
if ~isfile(dataFile)
    error("Dataset not found. Run generate_v9_current_feature_dataset.m first.");
end
...
allNames = string(T_v9.Properties.VariableNames);
predictorMask = allNames ~= "FamilyLabel" & allNames ~= "ResponseType";
predictorNames = allNames(predictorMask);

Xall = table2array(T_v9(:, predictorNames));
Yall = T_v9.FamilyLabel;
Rall = T_v9.ResponseType;
...
fprintf("\n=====================================================\n");
fprintf("V9 Current-Feature Hierarchical Classifier\n");
fprintf("=====================================================\n\n");
...
fprintf("\n=====================================================\n");
fprintf("V9 Overall current-feature hierarchical accuracy: %.2f %%\n", ...
    100*overallAcc);
fprintf("=====================================================\n\n");
...
resultFile = fullfile(resultsFolder, 'v9_current_feature_results.csv');
writetable(results, resultFile);

fig = figure;
cm = confusionchart(allTrue, allPred);
cm.Title = sprintf('V9 Current-Feature Classifier, Accuracy = %.2f%%', ...
    100*overallAcc);
cm.RowSummary = 'row-normalized';
cm.ColumnSummary = 'column-normalized';

figFile = fullfile(figFolder, 'v9_current_feature_confusion_matrix.png');
saveas(fig, figFile);
