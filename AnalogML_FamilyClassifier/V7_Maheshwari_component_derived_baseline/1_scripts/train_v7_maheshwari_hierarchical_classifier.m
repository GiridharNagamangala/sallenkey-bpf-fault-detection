...
% ============================================================
% Train V7 Maheshwari Component-Derived Hierarchical Classifier
%
% Dataset:
%   family_classifier_dataset_v7_maheshwari.mat
%
% Target:
%   FamilyLabel
%
% Hierarchical strategy:
%   Split by ResponseType first.
%   Train separate family classifier for LPF, HPF, BPF, BSF.
% ============================================================
...
if ~isfile(dataFile)
    error("Dataset not found. Run generate_v7_maheshwari_component_dataset.m first.");
end

load(dataFile, 'T_v7');

T_v7.FamilyLabel = categorical(T_v7.FamilyLabel);
T_v7.ResponseType = categorical(T_v7.ResponseType);

allNames = string(T_v7.Properties.VariableNames);

predictorMask = allNames ~= "FamilyLabel" & allNames ~= "ResponseType";
predictorNames = allNames(predictorMask);

Xall = table2array(T_v7(:, predictorNames));
Yall = T_v7.FamilyLabel;
Rall = T_v7.ResponseType;
...
fprintf("\n=====================================================\n");
fprintf("V7 Maheshwari Component-Derived Hierarchical Classifier\n");
fprintf("=====================================================\n\n");
...
fprintf("\n=====================================================\n");
fprintf("V7 Overall Maheshwari-derived hierarchical accuracy: %.2f %%\n", ...
    100*overallAcc);
fprintf("=====================================================\n\n");
...
resultFile = fullfile(resultsFolder, ...
    'v7_maheshwari_hierarchical_results.csv');

writetable(results, resultFile);

fig = figure;
cm = confusionchart(allTrue, allPred);
cm.Title = sprintf('V7 Maheshwari Component-Derived Classifier, Accuracy = %.2f%%', ...
    100*overallAcc);
cm.RowSummary = 'row-normalized';
cm.ColumnSummary = 'column-normalized';

figFile = fullfile(figFolder, ...
    'v7_maheshwari_hierarchical_confusion_matrix.png');
