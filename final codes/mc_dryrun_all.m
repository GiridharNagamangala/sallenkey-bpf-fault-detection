...
for k = 1:N
    ...
    R1 = R1_nom * (1 + (2 * round(rand()) - 1) * (tolRes + (0.50 - tolRes) * rand()));
    R2 = R2_nom*(1 + tolRes*(2 * rand() - 1));
    R3 = R3_nom*(1 + tolRes*(2 * rand() - 1));
    R4 = R4_nom*(1 + tolRes*(2 * rand() - 1));
    R5 = R5_nom*(1 + tolRes*(2 * rand() - 1));
    C1 = C1_nom*(1 + tolCap*(2 * rand() - 1));
    C2 = C2_nom*(1 + tolCap*(2 * rand() - 1));
